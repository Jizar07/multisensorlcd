...
// Add your Wifi info | Adicione sua informação de wifi
#define wifi_ssid "" 
...
#define light_state_topic "jizar/multisensor"
#define light_set_topic "jizar/multisensor/set"
...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "multisensor"
#define OTApassword "" // change this to whatever password you want to use when you upload OTA - Adicione uma Senha para OTA
int OTAport = 8266;
...
// LiquidCrystal_I2C lcd(0x3F, 16, 2);  // Your adress may be this one or different | Talvez o endereço do teu I2C seja esse.
...
void setup_lcd() {
  ...
  Wire.begin(D2, D1);
  lcd.begin(16,2);
  //lcd.init(); // If turn on, Screen will blink on every event change - Se ligado, faz a tua LCD pisca toda vez que tiver mudança na tela
  lcd.backlight();
}
...
// LCD top Line for motion - Linha de cima
  lcd.setCursor(0,0);
  lcd.print("Motion:"); 
  lcd.setCursor(8,0); 
  lcd.print((String)motionStatus);
  
// LCD Botton line for Temp/Hum - Linha de baixo
  lcd.setCursor(0,1);
  lcd.print("T:");
  lcd.setCursor(2,1); 
  lcd.print((String)tempValue);
  lcd.setCursor(7,1);
  lcd.print("F"); // Change it to C For Celsius - Mude de F para C para Celsius *********************************************
  
  lcd.setCursor(9,1);
  lcd.print("H:");
  lcd.setCursor(11,1);
  lcd.println((String)humValue);
  lcd.setCursor(15,1); 
  lcd.print("%");
